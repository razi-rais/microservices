...
##### NOTE: If you're using Azure make sure that vm type support nested virtualization (e.g. Standard_D2s_v3):https://docs.microsoft.com/en-us/azure/virtual-machines/windows/sizes-general#dsv3-series-sup1sup
# sudo -i
